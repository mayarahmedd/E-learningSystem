...
if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
	...
	$to = "E-learning programmers@gmail.com"; //Programmers email
	...
	$header  = "E-learning programmers@gmail.com";
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<abbr title="Phone Number"><strong>Phone:</strong></abbr> 01276664357<br>
