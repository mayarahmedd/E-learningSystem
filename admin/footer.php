		...
		<footer id="footer" class="dark">
			...
			<div id="copyrights">
				...
				<div class="container clearfix">
					...
					<div class="col_half">
						<br>
						Copyrights &copy; 2023 All Rights Reserved by EP<br>
					...
					<div class="col_half col_last tright">
						...
						<i class="icon-envelope2"></i> E-learningprogrammers@gmail.com <span class="middot">&middot;</span> <i class="icon-headphones"></i> 1234-1234567  <span class="middot"></span>
					</div>
