...
<!-- Page Sub Menu 
						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">E-learning website</h2>
									<p data-caption-animate="fadeInUp" data-caption-delay="200"></p>
								</div>
							</div>
							<div class="video-wrap">
								<img src="https://img.freepik.com/free-psd/laptop-screen-mockup-psd-desk-minimal-home-office-zone-design_53876-123252.jpg?w=1480&t=st=1682260181~exp=1682260781~hmac=dc4e75d1474be5e8dd2f1e46c3ef7f366166e73796351dd8ff4a82a82836f8fe">
								<div class="video-overlay" style="background-color: rgba(0,0,0,0.55);"></div>
							</div>
						</div>
						<div class="swiper-slide dark" style="background-image: url('images/slider/Slide1.jpg'); background-position: center top;">
							<div class="container clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
					...
					<div class="row clearfix">
						...
						<div class="col-lg-5">
							<div class="heading-block topmargin">
								<h1>Welcome to E-learning <br>Programmers</h1>
							</div>
							<p class="lead">We are a group of expertise programmers; our aim is to promote education. If you are a student, then contact us to secure your future. We deliver free international standard video lectures and content. We are also providing services in Web &amp; Software Development.</p>
						</div>

						<div class="col-lg-7">

							<div style="position: relative; margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								<img src="https://img.freepik.com/free-photo/close-up-male-hands-using-laptop-home_1150-790.jpg?w=1480&t=st=1682260709~exp=1682261309~hmac=5b4c6ac8883c83ed8659e5d3a6caf7213f2a054ba0966572231cc541444833d6" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="100" alt="Chrome">
				...
				<div class="container clearfix" id="features">
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="heading-block center">
							...
							<span class="divcenter">Our team and instructors have many unique qualities &amp; skills. Dear students, We are providing free online learning platform. Where your skills are polished.</span>
						</div>
						...
						<div class="col-md-4 hidden-sm bottommargin center">
							<img src="https://www.freeiconspng.com/thumbs/iphone-x-pictures/apple-iphone-x-pictures-5.png" alt="iphone 2">
						</div>
				...
				$query2 = "SELECT * FROM `admin` WhERE admin_id='$adminPost'";
