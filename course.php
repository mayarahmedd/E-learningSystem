...
if (!isset($_SESSION["student_id"])) {
	...
	echo 'alert(" please login to view our courses!!")';
	echo '</script>';
         ...
         while( $row = mysqli_fetch_assoc($result) ){
                ...
                echo '<div class="col-sm-6 col-md-3">
							<div class="thumbnail image_fade">
							  <img data-src="holder.js/300x200" alt="Image" src="admin/images/courses/'.$coursePic.'" style="display: block; border: 2px solid #555;">
							  <div class="caption">
